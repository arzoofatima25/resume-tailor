...
export function SignupPage() {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      showToast("Account created — welcome to Tailorly!", "success");
  ...
  return (
    <AuthShell
      ...
      subtitle="Start tailoring resumes in minutes — free."
      footer={
        <>
    ...
    >
      ...
      <GoogleSignInButton onClick={onGoogleSignIn} isLoading={googleLoading} label="Sign up with Google" />
